...
?>
  <div class="container-fluid mr-bot40 mg-posts-sec-inner">
        ...
        <div class="row">
            ...
            <?php } 
			//!Bearbeitet! Zufälliger Artikel, der nicht älter als 30 Wochen ist (eventuell noch ändern)
			//					   
            $newsup_you_missed_loop = new WP_Query(array( 'post_type' => 'post', 'posts_per_page' => 4, 'order' => 'DESC',  'ignore_sticky_posts' => true, 'orderby' => 'rand','date_query' => array(
        array(
            'after' => '30 week ago'
        )
    )));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 text-xs">
								...
								<span class="sep">Das Netz ©<?php echo date("Y"); ?></span>
								<?php
                            ...
                            <div class="col-md-6 text-right text-xs">
                                 <p>
									 ...
									 <span class="sep"><a href="/interner-bereich/">Intern</a></span>
								<?php
								/* translators: placeholder replaced with string */
								?>
								</p>
