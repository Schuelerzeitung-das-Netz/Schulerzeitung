    ...
    function newsup_get_posts($number_of_posts, $category = '0')
    {
        ...
        $ins_args = array(
            ...
            'ignore_sticky_posts' => true,
			 ...
			 //Uses only the Posts which are younger than 4 Weeks (CHANGE?)
    'date_query' => array(
        array(
            'after' => '20 week ago'
        )
      ...
      document.body.appendChild(e);
                     ...
                     <div class="post-share">
                          ...
                          <div class="post-share-icons cf">
							     ...
							     <a href="whatsapp://send?text=<?php echo    $post_link ?>" data-action="share/whatsapp/share"class="link whatsapp" target="_blank" >
