...
//toggle ad panel on main page SZ EDIT
$wp_customize->add_setting('adPanel',
    array(
        'default' => false,
        'capability' => 'edit_theme_options',
...
$wp_customize->add_control('adPanel',
    array(
        'label' => 'Aktiviere Ad auf der Startseite',
...
$wp_customize->add_control(
    new WP_Customize_Cropped_Image_Control($wp_customize, 'banner_advertisement_section',
        array(
            ...
            'description' => sprintf(esc_html__('Recommended Size %1$s px X %2$s px', 'newsup'), 410, 410),
            'section' => 'frontpage_advertisement_settings',
            'width' => 420,
            'height' => 420,
            'flex_width' => true,
...
//toggle breaking news on main page SZ EDIT
$wp_customize->add_setting('breakingNews',
    array(
        'default' => false,
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
...
$wp_customize->add_control('breakingNews',
    array(
        'label' => 'Aktiviere Wichtige News',
        'section' => 'frontpage_main_banner_section_settings',
        'type' => 'checkbox',
        'priority' => 120,
        //'active_callback' => 'newsup_main_banner_section_status',
...
$wp_customize->add_setting('breakingNewsCategory',
    array(
...
$wp_customize->add_control(new Newsup_Dropdown_Taxonomies_Control($wp_customize, 'breakingNewsCategory',
    array(
        'label' => 'Kategorie für Wichtige News',
        'description' => "Wähle eine Kategorie für Wichtige News aus",
        'section' => 'frontpage_main_banner_section_settings',
        'type' => 'dropdown-taxonomies',
        'taxonomy' => 'category',
        'priority' => 120,
...
// breakingNews Title
$wp_customize->add_setting('breakingNewsSectionTitle',
    array(
        'default' => "Das bewegt uns",
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
    )
);
...
$wp_customize->add_control( 'breakingNewsSectionTitle',
    array(
        'label' => 'Titel für Wichtige News',
        'description' => "Wähle einen Titel",
        'section' => 'frontpage_main_banner_section_settings',
		'type' => 'text',
        'priority' => 120,
      //  'active_callback' => 'newsup_main_banner_section_status'
