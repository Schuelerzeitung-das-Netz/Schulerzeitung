...
if (!function_exists('newsup_banner_tabbed_posts')):
    ...
    function newsup_banner_tabbed_posts()
    {
			...
			$breakingNewsCategory = newsup_get_option('breakingNewsCategory');
		
				//big right ad panel
				if(newsup_get_option("adPanel")) {
					
					?>
				
				<div class="mg-sidebar-news top-right-area col-md-4 mg-sidebar">
                   
					<div class="mg-widget mg-sidebar">
						<div class="wp-block-group">
							<div class="mg-sidebar">
								<div class="mg-wid-title">
									<h6><a style="color:white;" href="#"><?php echo("Anzeige")?></a></h6>
								</div>
									<div style="height: 100%; width: 100%;">
										<a href="<?php echo newsup_get_option("banner_advertisement_section_url");?>">
						...
						<?php
                            ...
                            echo $newsup_banner_advertisement;
                        ?>
										</a>
									</div>
				...
				if(!newsup_get_option('breakingNews')) {
            ?>
        ...
        <?php
				...
				<div class="mg-sidebar-news top-right-area col-md-4 mg-sidebar">
						...
						<div class="mg-widget mg-sidebar">
<div class="wp-block-group"><div class="mg-sidebar">
	
<div class="mg-wid-title">
<h6><a style="color:white;" href="<?php echo get_category_link($breakingNewsCategory) ?>"><?php echo(get_theme_mod('breakingNewsSectionTitle'))?></a></h6>
</div>

<?php
                            newsup_render_posts('categorised', $show_excerpt, $excerpt_length, $number_of_posts, $breakingNewsCategory);
                            ?>
	</div></div>
</div>
